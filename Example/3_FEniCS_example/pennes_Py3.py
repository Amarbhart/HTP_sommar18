...
scaleTot=scale;
nbrIter=1;
T=0 # Lägga in T för föregående plan här istället? Använda cooling law för att beräkna hur gamla T blir i varje steg?

# köra all kod i denna filen en gång för ett P, sen lägga in det resulterande T som "gammalt" T här, byta P till nytt P och inte definiera om u och v utan köra på de som var med i sista iterationen på körningen med det föregående P (då T-matrisen definierades)
